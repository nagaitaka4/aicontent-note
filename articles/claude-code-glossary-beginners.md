...
Claude Codeを触り始めると、最初にぶつかるのが「用語の壁」です。プロンプト、コンテキスト、リポジトリ……なんとなく触っているけど、ちゃんと理解できていない。

私自身も非エンジニアとして使いながら、最初に押さえておくとClaude Codeへの理解が早まると感じた用語をこのノートにまとめました。同じように迷っている方の参考になればと思います。
...
| **モデル** | AIの種類（Claude Sonnet、Claude Opusなど）。性能・得意分野・コストが違うため、用途で使い分けます。 |
| **温度（Temperature）** | 出力のランダム性を制御するパラメータ。低いほど安定した文章、高いほど発想寄りの文章になります。 |
