...
チャットに打ち込んだ文も、貼り付けた文も、添付したファイルも同じ扱いです。
公式は対象を「会話のまとまりと、その中身すべて」と説明しています。
...
・パスワードやカード番号は、AIに渡さない。ログインは人がやる<br>
・鍵そのものではなく「どこに置いてあるか」を伝える<br>
・渡さないものを、ルールのファイルに書いて毎回読ませる<br>
・その場かぎりの相談は、学習に使われないIncognitoチャットを使う<br>
・共有リンクは、設定の「共有したチャット」でときどき見直す

私は、ログインが必要な作業だけ自分の手でやると決めています。
