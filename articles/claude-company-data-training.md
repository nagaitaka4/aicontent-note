...
| プラン | 学習に使われるか | 保持期間 | 根拠 |
|---|---|---|---|
| Free・Pro・Max＋設定オン | 使われる | 5年 | [Claude Code公式 Data usage](https://code.claude.com/docs/en/data-usage) |
| Free・Pro・Max＋設定オフ | 新しいチャット・セッションは使われない | 30日 | 同上 |
| Team・Enterprise・API | 既定で使わない | 別の規定 | 同上・[料金ページ](https://claude.com/pricing) |
...
【メモ】<br>
学習の設定とは別に、Claude CodeはPC側にも記録を残す。<br>
~/.claude/projects/ に平文で30日。cleanupPeriodDays で変更可
...
| 安全性の分類器に引っかかった会話・自分から送ったフィードバック | オフでも使われる |
...
Pro・Maxの利用は、個人でも法人でもConsumer Termsの範囲です。
原文は「individuals or entities」の利用を、Commercial Termsから外しています。
