...
| `PERM-01`（**✅ 2026-09-10 07:32にXへ投稿済み**・記録は9/14） | 投稿 | 「許可80件・確認6件・拒否0件」「8/29の更新でBashの一部が自動から確認に」「9/2の更新では作業フォルダの外を読むときも確認」「確認を減らすための設定のはずが、1週間で2回増えてます」「Macをまだ更新してないので、気づいてませんでした」 |
