...
- **【最重要】ChatGPT広告が2026-08-24から欧州31市場で始まる**（[OpenAI公式「ChatGPT 広告、欧州全域へ拡大」2026-08-18](https://openai.com/index/chatgpt-ads-expands-across-europe/)・**本日CCがブラウザで日本語版の原文を直接確認**。WebFetchはopenai.comに403を返す）
  ...
  - ⚠️ **日本は今回の31市場に含まれていない。**「新たな8市場」の内訳は本ページに書かれていないため、**日本が既に対象かどうかはこのページからは判断できない**。「日本にも広告が来る」と書かない
  - ⚠️ **「無料・Goプランのみに広告が出て、Plus・Pro・Enterpriseは広告なし」という記述は英語メディア（Reuters系の要約・Search Engine Land等）発で、上記OpenAI公式ページには書かれていない。**使うなら別の一次情報を取り直す。**8/17の教訓（要約は"出典の所在"も作る）がそのまま当てはまる**
  - **このメディアへの意味**：AIの回答画面が**広告の在庫**になった。GEOの議論は「AIに引用されるか」だけだったが、**その隣に「AIに広告を出す」という枠が公式にできた**。検索が辿った道（自然検索＋広告の二層構造）をAI検索が追いかけている、という構造で語れる。**⚠️ 日本ではまだ体験できないので「やってみた」は書けない。構造の話に限定する**
